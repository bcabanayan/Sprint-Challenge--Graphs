...
# You may uncomment the smaller graphs for development and testing purposes. 122, 99, 83, 80, 11, 3] ['w', 'w', 's', 'w', 's', 's']
...
# add node with values for each exit
# as you move from room to room, add to graph
...
def traverseGraph(visited = []):
    ...
    # for every direction in the move queue
    while move_queue: 
        ...
        print('direction is', direction, 'move q is', move_queue)
        ...
        # if the new room value is not in the traversal graph...
                ...
                if direction == 'n':
                    traversal_graph[player.currentRoom.id]['s'] = prev_room
                elif direction == 's':
                    traversal_graph[player.currentRoom.id]['n'] = prev_room
                elif direction == 'e':
                    traversal_graph[player.currentRoom.id]['w'] = prev_room
                elif direction == 'w':
                    traversal_graph[player.currentRoom.id]['e'] = prev_room
        unexplored = []
